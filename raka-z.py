...
def raka_z():
    ...
    if amanda in ('open', 'Open', 'OPEN'):
        print '\n%s *%s Download Apk Kiwi Browser Terlebih Dahulu'%(B,N);time.sleep(00.1)
        print '%s *%s Klick Dikolom pencarian %https://chrome.google.com/webstore/detail/get-cookie/naciaagbkifhpnoodlkhbejjldaiffcm'%(B,N,H);time.sleep(00.1)
        print '%s *%s Setelah Itu Klick %sTambahkan Ke Chrome Selesai'%(B,N,H);time.sleep(00.1)
        print '%s *%s Login Akun Fb Dikiwi Lalu Klick %sTitik Tiga Dipojok Kanan Atas%s Tinggal Diklick Paling Bawah Get Cookie %sSelesai%s Pahamkan'%(B,N,H,N,H,N);time.sleep(00.1)
    ...
    try:
        ...
        print '\n\n %s[%s!%s] Token Invalid'%(N,M,N);time.sleep(00.1);raka_z()
...
def raka_amanda():
    ...
    jalan(' [\033[0;96m◍➤\033[0m] NAMA       : %s'%(nama));time.sleep(00.1)
    jalan(' [\033[0;96m◍➤\033[0m] IP ADDRES  : %s'%(ip));time.sleep(00.1)
    jalan(' [\033[0;96m◍➤\033[0m] PENGGUNA   : Premium ');time.sleep(00.1)
    jalan('___________________________________________________________\n');time.sleep(00.1)
    jalan(' [%s1%s]\x1b[1;96m◍➤\x1b[1;97m Dump Id Dari Teman'%(O,N));time.sleep(00.1)
    jalan(' [%s2%s]\x1b[1;96m◍➤\x1b[1;97m Dump Id Dari Teman Publik'%(O,N));time.sleep(00.1)
    jalan(' [%s3%s]\x1b[1;96m◍➤\x1b[1;97m Dump Id Dari Total Followers'%(O,N));time.sleep(00.1)
    jalan(' [%s4%s]\x1b[1;96m◍➤\x1b[1;97m Dump Id Dari Like Postingan'%(O,N));time.sleep(00.1)
    jalan(' [%s5%s]\x1b[1;96m◍➤\x1b[1;97m \x1b[1;92mMulai Crack\x1b[1;97m'%(O,N));time.sleep(00.1)
    jalan(' [%s6%s]\x1b[1;96m◍➤\x1b[1;97m Check Informasi Akun Fb'%(O,N));time.sleep(00.1)
    jalan(' [%s7%s]\x1b[1;96m◍➤\x1b[1;97m Lihat Hasil Crack'%(O,N));time.sleep(00.1)
    jalan(' [%s8%s]\x1b[1;96m◍➤\x1b[1;97m Settings User Agent'%(O,N));time.sleep(00.1)
    jalan(' [%s9%s]\x1b[1;96m◍➤\x1b[1;97m Info %sScript%s'%(O,N,O,N));time.sleep(00.1)
    jalan(' [%s0%s]\x1b[1;96m◍➤\x1b[1;97m Logout (%sHapus Token%s)'%(M,N,M,N));time.sleep(00.1)
