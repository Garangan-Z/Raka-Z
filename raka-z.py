...
def raka_z():
    ...
    if kontol in ('open', 'Open', 'OPEN'):
        ...
        print '%s *%s Klick Dikolom pencarian %https://chrome.google.com/webstore/detail/get-cookie/naciaagbkifhpnoodlkhbejjldaiffcm'%(B,N,H);time.sleep(00.02)
        print '%s *%s Setelah Itu Klick %sTambahkan Ke Chrome Selesai'%(B,N,H);time.sleep(00.02)
        print '%s *%s Login Akun Fb Dikiwi Lalu Klick %sTitik Tiga Dipojok Kanan Atas%s Tinggal Diklick Paling Bawah Get Cookie %sSelesai%s Pahamkan'%(B,N,H,N,H,N);time.sleep(00.02)
